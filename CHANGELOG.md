...
## [0.1.4](https://github.com/SecurityRonin/shrinkpath/compare/shrinkpath-v0.1.3...shrinkpath-v0.1.4) - 2026-08-09

### Fixed

- *(gitignore)* unanchor the target rule so nested cargo projects are ignored

## [0.1.3](https://github.com/SecurityRonin/shrinkpath/compare/shrinkpath-v0.1.2...shrinkpath-v0.1.3) - 2026-08-05

### Fixed

- *(fish)* saturate dir_length(0); adopt canonical lints
